      ...
      e: for (var K = 0, Z = C.length, pr = Z >>> 1; K < pr; ) {
        ...
        if (0 > l(Wl, O))
          _t < Z && 0 > l(hr, Wl)
            ? ((C[K] = hr), (C[_t] = O), (K = _t))
            : ((C[K] = Wl), (C[Ct] = O), (K = Ct))
        else if (_t < Z && 0 > l(hr, O)) (C[K] = hr), (C[_t] = O), (K = _t)
        else break e
      }
    }
    return R
  ...
  function x(C, R) {
    ...
    try {
      ...
      if (f !== null) var pr = !0
        ...
        var Ct = n(a)
        Ct !== null && Vl(w, Ct.startTime - R), (pr = !1)
      }
      return pr
    } finally {
      ;(f = null), (m = O), (k = !1)
    ...
    (e.unstable_scheduleCallback = function (C, R, O) {
      ...
      return (
        ...
        O > K
          ...
          : ((C.sortIndex = Z), t(s, C), y || k || ((y = !0), Hl(x))),
        C
      )
    }),
...
function xn(e, t) {
  e.blockedOn === t &&
    ((e.blockedOn = null),
    Bo ||
      ((Bo = !0), Se.unstable_scheduleCallback(Se.unstable_NormalPriority, gd)))
}
function Xn(e) {
  function t(l) {
    return xn(l, e)
...
var Wd = Ze && 'TextEvent' in window && !An,
        ...
        for (var c = a, h; c !== null; ) {
          ...
          if (
            (h.tag === 5 &&
              w !== null &&
              ((h = w),
              d !== null && ((w = Wn(c, d)), w != null && v.push(qn(c, w, h)))),
            T)
          )
            break
          c = c.return
      ...
      e: {
        ...
        if (
          ...
          if (
            ...
            t: {
              for (v = k, d = y, c = 0, h = v; h; h = Bt(h)) c++
              for (h = 0, w = d; w; w = Bt(w)) h++
              for (; 0 < c - h; ) (v = Bt(v)), c--
              for (; 0 < h - c; ) (d = Bt(d)), h--
              for (; c--; ) {
...
function xt() {
  if (!so && Ke !== null) {
    ...
    try {
      ...
      throw (Ke !== null && (Ke = Ke.slice(e + 1)), ka(Li, xt), l)
    } finally {
      ;(A = t), (so = !1)
    }
  }
...
function qa(e, t, n) {
  ;(xe[Ce++] = Xe), (xe[Ce++] = Je), (xe[Ce++] = Dt), (Dt = e)
  var r = Xe
  e = Je
  var l = 32 - Ae(r) - 1
  ;(r &= ~(1 << l)), (n += 1)
  ...
  switch (e.tag) {
    ...
    case 13:
      return (
        ...
        t !== null
          ? ((n = Dt !== null ? { id: Xe, overflow: Je } : null),
            (e.memoizedState = {
              dehydrated: t,
              treeContext: n,
...
function lc(e) {
      ...
      : c !== null &&
          (c.elementType === x ||
            (typeof x == 'object' &&
              ...
              x.$$typeof === ot &&
              ss(x) === c.type))
        ? ((w = l(c, h.props)), (w.ref = _n(d, c, h)), (w.return = d), w)
  ...
  function p(d, c, h, w, x) {
    return c === null || c.tag !== 7
      ? ((c = zt(h, d.mode, w, x)), (c.return = d), c)
      : ((c = l(c, h)), (c.return = d), c)
  }
  function f(d, c, h) {
  ...
  function m(d, c, h, w) {
    ...
    if (typeof h == 'object' && h !== null) {
      ...
      if (On(h) || Sn(h)) return x !== null ? null : p(d, c, h, w, null)
      Pr(d, h)
    }
    return null
  }
  function k(d, c, h, w, x) {
    ...
    if (typeof w == 'object' && w !== null) {
      switch (w.$$typeof) {
        ...
        case ot:
          var _ = w._init
          return k(d, c, h, _(w._payload), x)
      }
      if (On(w) || Sn(w)) return (d = d.get(h) || null), p(c, d, w, x, null)
      Pr(c, w)
    }
    return null
  }
  function y(d, c, h, w) {
    ...
    if (P === h.length) return n(d, N), B && Nt(d, P), x
    if (N === null) {
      for (; P < h.length; P++)
        (N = f(d, h[P], w)),
          N !== null &&
  ...
  function v(d, c, h, w) {
    ...
    for (
      var _ = (x = null), N = c, P = (c = 0), Q = null, z = h.next();
      N !== null && !z.done;
      P++, z = h.next()
    ) {
      N.index > P ? ((Q = N), (N = null)) : (Q = N.sibling)
    ...
    if (N === null) {
      for (; !z.done; P++, z = h.next())
        (z = f(d, z.value, w)),
          z !== null &&
            ((c = o(z, c, P)), _ === null ? (x = z) : (_.sibling = z), (_ = z))
      return B && Nt(d, P), x
    }
    for (N = r(d, N); !z.done; P++, z = h.next())
      (z = k(N, d, P, z.value, w)),
        z !== null &&
    ...
    if (
      ...
      switch (h.$$typeof) {
        ...
        case $t:
          ...
          return i(d)
        case ot:
          return (_ = h._init), T(d, c, _(h._payload), w)
      }
      if (On(h)) return y(d, c, h, w)
      if (Sn(h)) return v(d, c, h, w)
      Pr(d, h)
    }
...
function gc(e, t, n) {
  return (
    (n = n != null ? n.concat([e]) : null), Pl(4, 4, vc.bind(null, t, e), n)
  )
}
function tu() {}
function wc(e, t) {
...
function Cp(e, t, n, r, l, o, i) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = ho(Error(S(422)))), Tr(e, t, i, r))
      : t.memoizedState !== null
  ...
  if (l.data === '$!') {
    ...
    return (r = u), (o = Error(S(419))), (r = ho(o, r, void 0)), Tr(e, t, i, r)
  }
  if (((u = (i & e.childLanes) !== 0), pe || u)) {
    ...
    return su(), (r = ho(Error(S(421)))), Tr(e, t, i, r)
  }
  return l.data === '$?'
    ? ((t.flags |= 128),
      (t.child = e.child),
...
function Mc(e) {
  ...
  t !== null && ((e.alternate = null), Mc(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[Be], delete t[Zn], delete t[Jo], delete t[fp], delete t[dp])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = Xo(Pt.bind(null, e, de, Qe), t)
            break
          }
          Pt(e, de, Qe)
          break
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = Xo(Pt.bind(null, e, de, Qe), r)
            break
          }
          Pt(e, de, Qe)
          break
...
function yl(e, t) {
  ...
  while (!0)
  if ((Wi(), (D = n), (pl.current = r), J !== null)) throw Error(S(261))
...
ma = iu
ya = Mt
var Qp = { usingClientEntryPoint: !1, Events: [ar, Kt, Cl, pa, ha, iu] },
  Pn = {
...
const Jp = ({ person: e }) =>
    U.jsx(U.Fragment, {
      children: U.jsxs('h3', { children: [e.name, ' ', e.number] }),
    }),
  Yp = ({ phoneBook: e, deletePerson: t }) => {
    const [n, r] = Ye.useState(''),
      l = (u) => {
        r(u.target.value)
      },
      o = e.filter((u) => u.name.includes(n)),
      i = (u, s) => {
        window.confirm(`are you sure you want to delete ${u}?`) && t(s)
      }
    return U.jsxs('div', {
      children: [
        U.jsx('h2', { children: 'Numbers' }),
        U.jsx('input', { placeholder: 'filter...', onChange: l }),
        o.map((u) =>
          U.jsxs(
            'div',
            {
  ...
  Gp = ({ addPerson: e, phoneBook: t }) => {
    const [n, r] = Ye.useState(''),
      ...
      a = (p) => {
        p.preventDefault(), e({ name: n, number: l }), r(''), o('')
      }
    return U.jsxs('form', {
      onSubmit: a,
      children: [
        ...
        U.jsx('div', {
          children: U.jsx('button', {
            type: 'submit',
            disabled: i,
            children: i ? 'Name already added!' : 'add',
          }),
        }),
      ],
    })
  },
  qp = ({ message: e, positive: t }) =>
    e === null
      ? null
      : (console.log(t),
        t
          ? U.jsx('div', { className: 'successMessage', children: e })
          : U.jsx('div', { className: 'failMessage', children: e }))
function ef(e, t) {
  return function () {
...
const tm = $e.hasStandardBrowserEnv
  ? {
      write(e, t, n, r, l, o) {
...
const lm = $e.hasStandardBrowserEnv
  ? (function () {
...
const Bl = Y,
  $l = '/api/persons',
  mm = () => Bl.get($l).then((t) => t.data),
  ym = (e) => Bl.post($l, e).then((n) => n.data),
  vm = (e) => Bl.delete($l + `/${e}`).then((n) => n.data),
  gm = (e) => (
    console.log('updatedPerson', e),
    Bl.put(`${$l}/${e.id}`, e).then((n) => n.data)
  ),
  zr = { getPeople: mm, addPerson: ym, deletePerson: vm, updateNumber: gm },
  wm = () => {
    const [e, t] = Ye.useState([]),
      [n, r] = Ye.useState({ message: null, positive: null })
    Ye.useEffect(() => {
      console.log('effect'),
        zr.getPeople().then((u) => {
          t(u)
    ...
    const l = () => {
        r({ message: null, positive: !0 })
      },
      o = (u) => {
        const s = e.find((a) => a.name === u.name)
        console.log('existing person', s),
          s
            ? ((u = { ...u, id: s.id }),
              window.confirm(
                `${s.name} is already added to the phonebook, replace the old number with the new one?`
              ) &&
                zr
                  .updateNumber(u)
                  .then((a) => {
                    const p = {
                      message: `updated ${a.name}'s number`,
                      positive: !0,
                    }
                    r(p),
                      setTimeout(l, 3e3),
                      t(e.map((f) => (f.id === a.id ? a : f)))
                  })
                  .catch((a) => {
                    const p = { message: a.response.data.error, positive: !1 }
                    r(p), setTimeout(l, 3e3)
                  }))
            : zr
                .addPerson(u)
                .then((a) => {
                  const p = {
                    message: `added ${a.name} to the phonebook`,
                    positive: !0,
                  }
                  r(p), setTimeout(l, 3e3), t(e.concat(a))
                })
                .catch((a) => {
                  const p = { message: a.response.data.error, positive: !1 }
                  r(p), setTimeout(l, 3e3)
      ...
      i = (u) => {
        zr.deletePerson(u)
          .then((s) => {
            r({ message: 'person deleted ', positive: !0 }),
              setTimeout(l, 3e3),
              t(e.filter((p) => p.id !== u))
          })
          .catch((s) => {
            r({ message: 'person was already deleted', positive: !1 }),
              setTimeout(l, 3e3)
          })
      }
    return U.jsxs('div', {
      children: [
        U.jsx('h2', { children: 'Phonebook' }),
        U.jsx(qp, { message: n.message, positive: n.positive }),
        U.jsx(Gp, { addPerson: o, phoneBook: e }),
        U.jsx(Yp, { phoneBook: e, deletePerson: i }),
      ],
    })
  }
Eo.createRoot(document.getElementById('root')).render(U.jsx(wm, {}))
